...
export function Libp2pStreamPlayer({
  ...
  const { node, status, metadata, audioChunks, connect, disconnect, subscribe, unsubscribe, play, pause, peerId } =
    useLibp2pStream();
    ...
    <div className="card bg-base-100 shadow-xl">
      <div className="card-body">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          {status.connected && <div className="badge badge-success badge-sm">Connected</div>}
        </div>
        ...
        {status.connected && (
          <div className="space-y-3">
            ...
            <div className="card-actions justify-between items-center mt-4">
              <div className="text-sm text-gray-600">
                {audioChunks.length > 0 ? (
                  <span>{audioChunks.length} audio chunks ready</span>
                ) : status.subscribed ? (
            ...
            <div className="flex gap-2 justify-end">
              ...
              <button className="btn btn-sm btn-ghost" onClick={status.connected ? disconnect : connect}>
