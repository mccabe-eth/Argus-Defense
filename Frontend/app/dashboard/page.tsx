...
import { Activity, AlertTriangle, Clock, Database, MapPin, Shield, TrendingUp, Users } from "lucide-react";
  ...
  const recentThreats = [
    {
      id: 1,
      type: "Cyber",
      title: "State-sponsored APT detected",
    ...
    },
    {
      id: 2,
      type: "Natural",
      title: "Earthquake monitoring alert",
      location: "Pacific Ring",
      time: "15 min ago",
      severity: "medium",
    },
    {
