...
const Reports: NextPage = () => {
  const reports = [
    { id: 1, title: "Q4 2024 Cyber Threat Analysis", author: "0x742d...4e8f", date: "2024-12-15", status: "verified", ipfs: "Qm..." },
    { id: 2, title: "Supply Chain Vulnerability Assessment", author: "0x8a3c...2d1b", date: "2024-12-10", status: "pending", ipfs: "Qm..." },
    { id: 3, title: "Geopolitical Risk Report - Central Asia", author: "0x5f1a...9c7e", date: "2024-12-05", status: "verified", ipfs: "Qm..." },
  ];
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <Card className="p-6 bg-card/50 border-primary/20 mb-6">
          ...
          <p className="text-muted-foreground mb-4">
            Share threat intelligence with the community. Reports are stored on IPFS and verified through community validation.
          </p>
        ...
        <div className="grid gap-4">
          {reports.map((report) => (
            <Card key={report.id} className="p-6 bg-card/50 border-primary/20 hover:border-primary/40 transition-colors">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    <Badge variant={report.status === "verified" ? "default" : "outline"} className="text-xs capitalize">
                      {report.status}
                    </Badge>
