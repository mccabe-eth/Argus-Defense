...
import { Book, Code, Shield, Wallet, Radio, FileText } from "lucide-react";
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Complete guide to using the Argus Defense platform
          </p>
        </div>
        ...
        <Card className="mt-8 p-6 bg-card/50 border-primary/20">
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              Argus Defense is a decentralized threat intelligence platform that combines real-time 
              monitoring, community validation, and blockchain verification to provide transparent 
              and reliable threat intelligence.
            </p>
            <p>
              The platform monitors global threats including cyber attacks, natural disasters, 
              geopolitical events, and supply chain disruptions. Reports are validated by the 
              community through a stake-based system and stored on IPFS for permanent accessibility.
            </p>
            <p>
              Additionally, Argus Defense integrates emergency radio stream monitoring powered by 
              libp2p, allowing users to monitor critical communications and earn rewards for participation.
            </p>
          </div>
        </Card>
      </main>
