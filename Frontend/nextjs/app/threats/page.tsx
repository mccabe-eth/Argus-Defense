...
const Threats: NextPage = () => {
  ...
  const threats = [
    { id: 1, type: "Cyber", title: "State-sponsored APT campaign targeting critical infrastructure", location: "Eastern Europe", time: "2 hours ago", severity: "critical", status: "active" },
    { id: 2, type: "Natural", title: "Severe weather system approaching coastal regions", location: "Pacific Coast", time: "5 hours ago", severity: "high", status: "monitoring" },
    { id: 3, type: "Supply Chain", title: "Major port disruption affecting global logistics", location: "Southeast Asia", time: "1 day ago", severity: "high", status: "active" },
    { id: 4, type: "Geopolitical", title: "Border tensions escalating in disputed territory", location: "Central Asia", time: "2 days ago", severity: "medium", status: "monitoring" },
    { id: 5, type: "Cyber", title: "Ransomware campaign targeting healthcare sector", location: "North America", time: "3 days ago", severity: "high", status: "active" },
    { id: 6, type: "Natural", title: "Seismic activity increase in volcanic region", location: "Pacific Ring of Fire", time: "1 week ago", severity: "low", status: "resolved" },
  ];
            ...
            <Card key={threat.id} className="p-6 bg-card/50 border-primary/20 hover:border-primary/40 transition-colors">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex gap-2">
                  ...
                  <Button variant="cyber" size="sm">Validate</Button>
                </div>
              </div>
            </Card>
          ))}
