...
import { SignalIcon, GlobeAltIcon, UserGroupIcon, MagnifyingGlassIcon, FunnelIcon } from "@heroicons/react/24/outline";
...
const StreamsPage: NextPage = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      mounted = false;
      if (directory) {
        directory.stop().catch(console.error);
      }
      if (node) {
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="card-body">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="card-title text-lg">Decentralized P2P Network</h2>
                  <p className="text-sm text-gray-500 font-mono">Node: {peerId.slice(0, 20)}...</p>
                </div>
              </div>
              ...
              <div className="stats shadow">
                <div className="stat place-items-center">
                  ...
                  <div className="stat-value text-primary">{peerCount}</div>
                ...
                <div className="stat place-items-center">
                  <div className="stat-title">Discovered Streams</div>
                  <div className="stat-value text-secondary">{streams.length}</div>
                  <div className="stat-desc">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Fully decentralized P2P streaming - No central servers, no censorship
          </p>
        </div>
